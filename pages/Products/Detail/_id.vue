  ...
  export default {
    ...
    methods: {
      ...
      SubmitData() {
        ...
        vm.$axios
          .$post(`https://ucarebackend20231109.azurewebsites.net/Inquire?proid=${vm.ProID}`, AllData)
          .then((response) => {
    ...
    async asyncData({ $axios, params }) {
      ...
      return await $axios.get(`https://ucarebackend20231109.azurewebsites.net/product/${ProID}`).then((res) => {
        let getList = {}
